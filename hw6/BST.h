...
protected:
    ...
    void remove(const Comparable &x, BinaryNode *&_root) {
        ...
        BinaryNode *replaceNode = nullptr;
        ...
        //这里求助了AI：在删除节点后得到新的二叉树后，从根节点构造一条到原目标节点的路径，然后从下至上依次执行平衡操作
        std::vector<BinaryNode *> ancestors;
        for (BinaryNode *currentNode = _root; currentNode != nullptr;) {
