...
public:
    ...
    public:
        ...
        virtual /**
         * @brief 作业：迭代器的前置自减运算符. 用于将迭代器指向上一个节点.
         *
        ...
        /**
         * @brief 作业：迭代器的后置自减运算符. 用于将迭代器指向上一个节点.
         *
         * @return const_iterator 上一个节点的迭代器.
         */
        const_iterator operator--(int) {
    ...
    public:
        ...
        /**
         * @brief 作业：迭代器的前置自减运算符. 用于将迭代器指向下一个节点.
         *
        ...
        /**
         * @brief 作业：迭代器的后置自减运算符. 用于将迭代器指向下一个节点.
         *
         * @return iterator 上一个节点的迭代器.
         */
        iterator operator--(int) {
...
public:
    ...
    /**
     * @brief 补充：更新 List 当前节点的数据（左值版本）
     * @param itr 更新位置的迭代器.
     *
     */
    void update(iterator itr, const Object &x) {
        itr.current->data = x;
    }

    /**
     * @brief 补充：更新 List 当前节点的数据（右值版本）
     * @param itr 更新位置的迭代器.
     *
     */
    void update(iterator itr, Object &&x) {
        itr.current->data = std::move(x);
    }

    /**
     * @brief 补充：查找链表中第一个匹配的元素
     *
     * @param value 要查找的值
     * @return iterator 如果找到，则返回指向首个匹配元素的迭代器
     * @return end() 如果未找到，则返回链表的结尾迭代器
     */
    iterator find(const Object &value) {
